...
namespace ContentService.Services
{
    public class FilmImportService
    {
        ...
        public async Task ImportFilmAsync(FilmImportDto dto)
        {
            if (await _filmRepository.ExistsAsync(dto.ExternalID, dto.ExternalSource)) return;
            ...
            foreach (var genreName in uniqueGenres)
            {
                ...
                newFilm.ContentGenres.Add(new ContentGenre { Genre = genre });
            }
            ...
            foreach (var tagName in uniqueTags)
            {
                ...
                newFilm.ContentTags.Add(new ContentTag { Tag = tag });
            }
            ...
            foreach (var langCode in uniqueLangs)
            {
                ...
                newFilm.ContentLanguages.Add(new ContentLanguage { Language = language });
            }
